...
local mappings = {
	builtins = {
		...
		["n|<leader>e"] = map_cr("NvimTreeFocus"):with_noremap():with_silent():with_desc("file: Focus NvimTree"),
		["t|<C-c>"] = map_cmd("<C-\\><C-n><Cmd>bd<CR>"):with_noremap():with_desc("terminal: Kill & close"),
		...
		["n|I"] = map_cmd("i"):with_noremap():with_desc("edit: Insert at cursor (override default)"),
