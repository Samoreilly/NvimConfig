...
local mappings = {
	core = {
		-- Add these inside your `mappings.core` table
["v|<leader>y"] = map_cr('"+y'):with_silent():with_noremap():with_desc("Copy selection to system clipboard"),
["n|<leader>Y"] = map_cr('"+Y'):with_silent():with_noremap():with_desc("Copy line to system clipboard"),
["n|<leader>p"] = map_cr('"+p'):with_silent():with_noremap():with_desc("Paste from system clipboard after cursor"),
["n|<leader>P"] = map_cr('"+P'):with_silent():with_noremap():with_desc("Paste from system clipboard before cursor"),
